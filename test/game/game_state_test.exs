defmodule ElMascarar.GameStateTest do
  ...
  test "judge takes it all from court" do
    assert create_game(["Queen", "King", "Thief", "Judge", "Bishop", "Liar"])
      |> switch(1, true)
      |> switch(0, true)
      |> switch(0, true)
      ...
      |> pass == %{
        players: [
          %{ card: "Unknown", true_card: "Judge", money: 5 },
          %{ card: "Unknown", true_card: "King", money: 8 },
          %{ card: "Unknown", true_card: "Queen", money: 6 },
          %{ card: "Unknown", true_card: "Thief", money: 5 },
        ],
        free_cards: [
  ...
  test "lying about being judge doesn't clear the court" do
    assert create_game(["Queen", "King", "Thief", "Judge", "Bishop", "Liar"])
      |> switch(1, true)
      |> switch(0, true)
      |> switch(0, true)
      ...
      |> pass == %{
        players: [
          ...
          %{ card: "King", true_card: "King", money: 5 },
          %{ card: "Unknown", true_card: "Queen", money: 6 },
          %{ card: "Thief", true_card: "Thief", money: 4 },
        ],
        free_cards: [
          %{ card: "Unknown", true_card: "Bishop" },
          %{ card: "Unknown", true_card: "Liar" }
  ...
  test "judge gets the amount of money that is in court" do
    assert create_game(["Queen", "King", "Thief", "Judge", "Bishop", "Liar"])
      |> ready
      |> switch(1, true)
      |> switch(0, true)
  ...
  test "judge gets the amount of money that is in court when revealed" do
    assert create_game(["Queen", "King", "Thief", "Judge", "Bishop", "Liar"])
      |> ready
      |> switch(1, false)
      |> switch(0, true)
      ...
      |> activate("Judge") == %{
        players: [
          ...
          %{ card: "Judge", true_card: "Judge", money: 7 },
          %{ card: "King", true_card: "King", money: 5 },
          %{ card: "Queen", true_card: "Queen", money: 7 },
        ],
        free_cards: [
          %{ card: "Unknown", true_card: "Bishop" },
          %{ card: "Unknown", true_card: "Liar" }
  ...
  test "new reveal implementation returning all states" do
    assert create_game(["Queen", "King", "Thief", "Judge", "Bishop", "Liar"])
      |> ready
      |> switch(1, true)
      |> switch(0, true)
