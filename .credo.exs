  ...
  configs: [
    %{
      ...
      files: %{
        ...
        included: ["web/", "test/"],
        excluded: ["web/game/", "test/game/game_state_test.exs", "web/web.ex", "test/support/", "test/test_helper.exs"]
      },
      #
      ...
      checks: [
        ...
        {Credo.Check.Readability.MaxLineLength, priority: :high, max_length: 80},
